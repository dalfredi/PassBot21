    ...
    protected static ReplyKeyboard orderCardUser(Long orderId) {
        List<InlineKeyboardButton> buttons = Arrays.asList(
            InlineKeyboardButton.builder()
                ...
                .callbackData(
                    Buttons.Edit.CALLBACK + Buttons.SEPARATOR + orderId)
                .build(),
            InlineKeyboardButton.builder()
                .text(Buttons.Delete.TEXT)
                .callbackData(
                    Buttons.Delete.CALLBACK + Buttons.SEPARATOR + orderId)
                .build()
        );
        ...
        return InlineKeyboardMarkup.builder()
            .keyboardRow(
                Collections.singletonList((InlineKeyboardButton.builder()
                    ...
                    .callbackData(
                        Buttons.Approve.CALLBACK + Buttons.SEPARATOR + orderId)
                    .build())))
            .keyboardRow(
                Collections.singletonList(InlineKeyboardButton.builder()
                    .text(Buttons.Decline.TEXT)
                    .callbackData(
                        Buttons.Decline.CALLBACK + Buttons.SEPARATOR + orderId)
                    .build()))
            .build();
    }
}
